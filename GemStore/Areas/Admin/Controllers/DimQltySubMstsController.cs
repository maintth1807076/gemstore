...
namespace GemStore.Areas.Admin.Controllers
{
    public class DimQltySubMstsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DimSubTypeId, DimQlty,DimSubThumbnail")] DimQltySubMst dimQltySubMst)
        {
            dimQltySubMst.DimSubTypeId = "dims" + Guid.NewGuid().ToString().GetHashCode().ToString("x");
