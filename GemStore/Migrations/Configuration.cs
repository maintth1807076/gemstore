    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GemStoreContext>
    {
        ...
        protected override void Seed(GemStoreContext context)
        {
            ...
            context.BrandMsts.AddOrUpdate(x => x.BrandId,
                ...
                new BrandMst() { BrandId = "5", BrandType = "Mikimoto", }
            );
            ...
            var listOrders = new List<Order>()
            {
                ...
                new Order()
                {
                    ...
                    {
                        new OrderDetail(){StyleCode = "1", UnitPrice = 75, Quantity = 3},
                        new OrderDetail(){StyleCode = "2", UnitPrice = 85, Quantity = 3},
                        new OrderDetail(){StyleCode = "3", UnitPrice = 50, Quantity = 3},
                        new OrderDetail(){StyleCode = "4", UnitPrice = 93, Quantity = 3},
                        new OrderDetail(){StyleCode = "5", UnitPrice = 224, Quantity = 3},
                        new OrderDetail(){StyleCode = "6", UnitPrice = 115, Quantity = 3},
                        new OrderDetail(){StyleCode = "159", UnitPrice = 80, Quantity = 7},
                        new OrderDetail(){StyleCode = "39", UnitPrice = 80, Quantity = 7},
                        new OrderDetail(){StyleCode = "89", UnitPrice = 80, Quantity = 7},
                        new OrderDetail(){StyleCode = "84", UnitPrice = 80, Quantity = 7},
                        new OrderDetail(){StyleCode = "79", UnitPrice = 80, Quantity = 7},
                        new OrderDetail(){StyleCode = "220", UnitPrice = 80, Quantity = 7},
                    }
                }
            };
            var totalPrice = 0.0;
